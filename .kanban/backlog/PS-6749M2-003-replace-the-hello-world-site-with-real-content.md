...
The bootstrap shipped a `astro` hello-world site to `https://main.d3qcuq1iew2ake.amplifyapp.com`. Replace it with the
...
- The live URL is `https://main.d3qcuq1iew2ake.amplifyapp.com`.
...
- The deploy workflow ships the change to `https://main.d3qcuq1iew2ake.amplifyapp.com`.
...
1. The homepage at `https://main.d3qcuq1iew2ake.amplifyapp.com` shows real content.
