...
4. Push to `main`.
5. Visit `https://main.d3qcuq1iew2ake.amplifyapp.com` from a browser; confirm a hit lands in the provider's dashboard.
...
1. Provider snippet committed and shipped to `https://main.d3qcuq1iew2ake.amplifyapp.com`.
