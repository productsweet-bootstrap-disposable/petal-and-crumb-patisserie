...
Confirm that an end-to-end push to `main` actually deploys to `https://main.d3qcuq1iew2ake.amplifyapp.com` and that the live URL
...
- HTTPS-GET `https://main.d3qcuq1iew2ake.amplifyapp.com` and confirm the response code is 200 and the body changed.
...
- Live URL: `https://main.d3qcuq1iew2ake.amplifyapp.com`
...
- Repo: `https://github.com/productsweet-bootstrap-disposable/petal-and-crumb-patisserie`
...
5. HTTPS-GET `https://main.d3qcuq1iew2ake.amplifyapp.com` and confirm the README change is reflected in the served HTML (or
...
- `curl -sSf https://main.d3qcuq1iew2ake.amplifyapp.com` returns 200.
