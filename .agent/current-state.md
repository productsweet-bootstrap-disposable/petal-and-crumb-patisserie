...
health: green
tests_passing: 1
active_objectives: ["PS-6749M2-001"]
blockers: []
---
...
- **Deploy verified:** HTTPS 200 at https://main.d3qcuq1iew2ake.amplifyapp.com.
...
- **Framework:** astro
- **GitHub Repo:** https://github.com/productsweet-bootstrap-disposable/petal-and-crumb-patisserie
- **Default Branch:** `main`
- **AWS Account:** `874373490779`
- **AWS Region:** `ap-southeast-2`
- **Amplify App ID:** `d3qcuq1iew2ake`
- **Live URL:** https://main.d3qcuq1iew2ake.amplifyapp.com
- **Custom Domain:** https://main.d3qcuq1iew2ake.amplifyapp.com
- **Owner:** productsweet-bootstrap-disposable
- **Bootstrap Feature Flag:** `01KXAXN87VFAQ25AY75Y6749M2` (per AI6P-249 Q8 per-tenant flag)
- **Bootstrap ID:** `01KXAXN87VFAQ25AY75Y6749M2`

## Shipped Capabilities

### Hosting & Delivery
- AWS Amplify app `d3qcuq1iew2ake` connected to `main`, build spec matched to the framework.
