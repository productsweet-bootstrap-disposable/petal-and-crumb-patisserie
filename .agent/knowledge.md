...
**Name:** petal-and-crumb-patisserie
...
- **Repository:** https://github.com/productsweet-bootstrap-disposable/petal-and-crumb-patisserie
...
- **Hosting:** AWS Amplify Hosting on the `main` branch with the build spec recommended for the
  ...
  env-cache pattern.
- **Custom Domain:** https://main.d3qcuq1iew2ake.amplifyapp.com. Route53 hosted zone reused per the AI6P pattern; if
